...
import com.example.android.movieapplication.ui.tvshows.TvShowPagingAdapter
        ...
        adapter =
            TvShowPagingAdapter(
                TvShowPagingAdapter.OnClickListener { movieId: Long, imageView: ImageView ->
                    ...
                    findNavController()
                        .navigate(
                            TvViewPagerFragmentDirections.actionTvViewPagerFragmentToTvShowDetailFragment(
                                movieId
                            ),
                            extras
                        )
