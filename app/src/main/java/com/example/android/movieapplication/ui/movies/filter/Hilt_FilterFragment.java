...
public abstract class Hilt_FilterFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_FilterFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((FilterFragment_GeneratedInjector) generatedComponent()).injectFilterFragment(UnsafeCasts.<MovieFilterFragment>unsafeCast(this));
  }
